...
const demoProducts = [
  ...
  { id: 5, name: "Creator Studio 17", price: 1799, desc: "For creators and designers.", img: "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=400&q=80" },
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 max-w-5xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-left">Computers</h1>
