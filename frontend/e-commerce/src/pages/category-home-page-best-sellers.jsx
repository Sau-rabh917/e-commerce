...
const demoProducts = [
  { id: 1, name: "Smartphone Max", price: 799, desc: "Top-selling flagship phone.", img: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80" },
  { id: 2, name: "Wireless Earbuds Pro", price: 99, desc: "Best sound, best comfort.", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=400&q=80" },
...
const CategoryHomePageBestSellers = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full max-w-full overflow-x-hidden">
      ...
      <div className="flex-1 w-full max-w-full py-8 px-2 sm:px-4 mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-left">Home Page Best Sellers</h1>
        <p className="text-gray-600 mb-6 text-left">All home page best selling products will be shown here.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {filtered.map(product => (
            <ProductFlipCard
              key={product.id}
              product={product}
              // Add onAddToCart/onAddToWishlist if available
            />
          ))}
...
export { demoProducts };
export default CategoryHomePageBestSellers; 